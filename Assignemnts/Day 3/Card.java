...
public class Card {
     ...
     *
     * @param next this is a parameter which is passed to compare with the current
     *             card.
     * @return this will return 1 if the card is less than the current card and -1
     *         if the card is grater than the current card
     */
